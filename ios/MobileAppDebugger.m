...
@implementation MobileAppDebugger
...
^(NSException *exception, NSString *readeableException){
    ...
    [NSTimer scheduledTimerWithTimeInterval:5.0
                                     target:[MobileAppDebugger class]
...
RCT_EXPORT_METHOD(setNativeExceptionHandler:(BOOL)callPreviouslyDefinedHandler withCallback: (RCTResponseSenderBlock)callback)
{
...
void HandleException(NSException *exception)
{
    ...
    NSArray *callStack = [MobileAppDebugger backtrace];
